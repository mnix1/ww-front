...
import {getText, TEXT_WAR, TEXT_DRAW_CATEGORY, TEXT_DRAW_DIFFICULT, TEXT_QUESTION} from "../../../../lang/text";
...
class WarPageIntro extends React.PureComponent {
    ...
    renderText(text, component, to = {
        ...
        return <Anime
            ...
            from={{opacity: 0}}
            to={to}>
            <div className='pageHeader warPageIntroHeader'>{text}</div>
        </Anime>;
    }
    ...
    render() {
        ...
        return <div className='pageContent warPageIntro'>
            {component === 0 && this.renderText(getText(TEXT_WAR), 1)}
            {this.renderProfiles()}
