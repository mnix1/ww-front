...
export default function SvgMask(
    ...
    const notSafeTop = targetTop - padding;
    const heightPadding = padding + notSafeTop - top;
    const left = hx.safe(targetLeft - padding);
    const notSafeLeft = targetLeft - padding;
    const widthPadding = padding + notSafeLeft - left;
    const height = hx.safe(targetHeight + heightPadding * 2);
    const width = hx.safe(targetWidth + widthPadding * 2);
