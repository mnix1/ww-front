...
export const RIVAL_STATUS_WAITING_FAST = 'WAITING_FAST';
export const RIVAL_STATUS_START_FAST = 'START_FAST';
export const RIVAL_STATUS_CANCELED_FAST = 'CANCELED_FAST';
export const RIVAL_STATUS_ERROR_FAST = 'ERROR_FAST';
