...
export const RIVAL_CONTENT_STATUS_CHOOSING_TASK_CATEGORY = 'CHOOSING_TASK_CATEGORY';
export const RIVAL_CONTENT_STATUS_CHOOSING_TASK_DIFFICULTY = 'CHOOSING_TASK_DIFFICULTY';
export const RIVAL_CONTENT_STATUS_RANDOM_TASK_PROPS = 'RANDOM_TASK_PROPS';
export const RIVAL_CONTENT_STATUS_CHOOSING_WHO_ANSWER = 'CHOOSING_WHO_ANSWER';
export const RIVAL_CONTENT_STATUS_CHANGING_TASK = 'CHANGING_TASK';
...
export const RIVAL_IMPORTANCE_TRAINING = 'TRAINING';
